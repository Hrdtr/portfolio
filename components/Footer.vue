<template>
  ...
  >
    <div
      ...
      "
    >
      <div class="mt-2 mb-2 md:mb-0">
        © Cognitive.ID 2020. All Rights Reserved.
      </div>
      <div class="flex md:grid md:grid-cols-4 md:gap-2">
        <a
          href="https://twitter.com/hrdtr_"
          target="_blank"
          class="w-6 mr-2 md:mr-0"
        >
          <svg
            class="fill-current"
        ...
        <a
          href="https://web.facebook.com/profile.php?id=100007248255396"
          target="_blank"
          class="w-6 mr-2 md:mr-0"
        >
          <svg
        ...
        <a
          href="https://www.linkedin.com/in/herdi-tr-778142170"
          target="_blank"
          class="w-6 mr-2 md:mr-0"
        >
          <svg
